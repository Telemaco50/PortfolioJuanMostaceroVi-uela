...
import islandScene from "../assets/3d/Monitor.glb";
...
export function Monitor({ ...props }) {
  ...
  // Cargar las texturas
  const lightMapTexture = useLoader(THREE.TextureLoader, 'src/assets/3d/bakes/lamp_02_Bake1_PBR_Lightmap.png');
  const aoMapTexture = useLoader(THREE.TextureLoader, 'src/assets/3d/bakes/lamp_02_Bake1_PBR_Ambient Occlusion.png');
  const diffuseMapTexture = useLoader(THREE.TextureLoader, 'src/assets/3d/bakes/lamp_02_Bake1_CyclesBake_COMBINED.png');
  ...
  return (
    <a.group ref={islandRef} {...props} scale={5}>
      <group
        position={[0, 0, 0]}
        rotation={[0, 0, 0]}
        scale={[5, 5, 5]}
